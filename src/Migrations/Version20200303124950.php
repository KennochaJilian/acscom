 ...
 */
final class Version20200303124950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_questions (id INT AUTO_INCREMENT NOT NULL, contact_id INT NOT NULL, reasonquestion VARCHAR(255) NOT NULL, INDEX IDX_4DBC86E5E7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
